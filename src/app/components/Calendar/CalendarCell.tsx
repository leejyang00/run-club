  ...
  return (
    <div className="flex flex-col p-1 sm:h-24">
      <div className="w-full flex justify-end">
        <span
          className={`text-xs ${
            cell.getMonth() !== month ? "text-gray-300" : ""
          }`}
        >
          {cell.getDate()}
        </span>
      ...
      {events.map((item, idx) => (
        <div key={idx} className="group">
          <div
            className="text-xs border-l-4 border-solid border-cyan-700 pl-1 cursor-pointer mb-2"
          ...
          >
            <Box className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 outline-0 shadow-xl w-3/4 max-h-128 overflow-scroll lg:w-1/2">
              <div className="p-10 bg-white">
                ...
                <div className="flex flex-col w-full items-center md:flex-row">
                  <a href={item.route} target="_blank">
                    <Button
                      variant="contained"
                      className="bg-cyan-700 max-w-fit m-0 hover:bg-cyan-700 md:mr-5"
                    >
                      Route
                    </Button>
                  </a>
              ...
              <div
                className="bg-[#FFFFF4] px-10 py-4 text-sm"
